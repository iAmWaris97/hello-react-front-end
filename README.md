...
**Hello-React-Front-End** is a React app which fetches a random message from the rails API app from the [hello-rails-back-end](https://github.com/iAmWaris97/hello-rails-back-end) project.
...
- [hello-rails-back-end](https://github.com/iAmWaris97/hello-rails-back-end)
...
```sh
 git clone https://github.com/iAmWaris97/hello-react-front-end.git
```
